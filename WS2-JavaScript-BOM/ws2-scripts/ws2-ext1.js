 ...
 */
const figureTarget = document.querySelector("#js-figureTarget");
const quoteTarget = document.querySelector("#js-quoteTarget");
const authorTarget = document.querySelector("#js-authorTarget");
